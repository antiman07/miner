...
//if opt_debug variable is open,opt_log_output variable is open also
//if opt_debug variable is close,and opt_log_level default is LOG_NOTICE,
//so let prio <= opt_log_level value is LOG_ERR or LOG_WARNING
